        ...
        <main className="container mx-auto px-8 py-8 sm:py-16 pt-8 sm:pt-24 max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between sm:items-start gap-4 mb-12">
            <div className="max-w-lg text-center sm:text-left">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground">
                Driven individual with a passion for problem-solving, continuous learning, and mastering
                advanced
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              I particularly enjoy <span
              className="font-medium text-foreground">competitive programming</span> and
              tackling complex problems. I love learning new technologies and building websites with the
              latest tech stacks. Additionally, I take pride in my typing skills, often reaching speeds of
              over
