...
export default function Home() {
  const languages = ["C++", "Python", "Java", "Go", "JavaScript", "TypeScript"];
  const frameworks = [
    "Springboot",
    "Flask",
    "Pandas",
  ...
  const socialHandles = [
    ...
    },
    {
      name: "Threads",
      icon: AtSign,
      url: "https://www.threads.net/@aftaab___",
    },
      ...
      <div className="min-h-screen bg-background">
        <main className="container mx-auto px-8 py-8 sm:py-16 pt-16 sm:pt-24 max-w-4xl">
          ...
          <section className="mb-12">
            ...
            <p className={`underline text-lg font-medium mb-4`}>
              Currently exploring:
            </p>
          ...
          <section className="text-center mt-20">
            ...
            >
              <Link
                href="/assets/Resume_Aftaab_Siddiqui.pdf"
                target="_blank"
          ...
          <section className="text-center mt-24 mb-24">
            ...
            <p className="text-lg text-muted-foreground">
              Dive into my thoughts on technology, coding journeys, and the
              ever-evolving world of software development. Occasionally, I also
              share insights on topics beyond tech.
            </p>
          </section>
